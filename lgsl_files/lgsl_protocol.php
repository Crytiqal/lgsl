...
//------------------------------------------------------------------------------------------------------------+
  ...
  function lgsl_software_link($type, $ip, $c_port, $q_port, $s_port)
  {
    ...
    "etqw"          => "qtracker://{IP}:{S_PORT}?game=EnemyTerritoryQuakeWars&action=show",
    ...
    "rtcw"          => "qtracker://{IP}:{S_PORT}?game=ReturntoCastleWolfenstein&action=show",
...
//---------------------------------------------------------+
    ...
    if ($server['b']['type'] == "etqw") { fwrite($lgsl_fp, "\xFF\xFFgetInfoEX\xFF"); }
